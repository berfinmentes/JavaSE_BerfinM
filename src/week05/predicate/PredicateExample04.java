...
public class PredicateExample04 {
    public static void main(String[] args) {
        ...
        /* Predicate<String> predicate2 = String::length;              /*Integer döndüğü için kullanamayız*/
        // Predicate<String> predicate3 = String::startsWith;          /*Parametre istediği için çalışmaz*/
    }
}
